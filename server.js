...
const contracts = [
    { 
        contractId: 'fipavie-ingenierie', 
        name: 'Fipavie Ingénierie', 
        minimumInvestment: 10000, 
        funds: { 
            secure: ['fund-001', 'fund-003', 'fund-007', 'fund-015', 'fund-002', 'fund-004'], 
            moderate: ['fund-001', 'fund-003', 'fund-005', 'fund-007', 'fund-015', 'fund-016', 'fund-006'], 
            dynamic: ['fund-003', 'fund-005', 'fund-007', 'fund-011', 'fund-012', 'fund-017', 'fund-004'] 
        } 
    },
    { 
        contractId: 'fipavie-opportunites', 
        name: 'Fipavie Opportunités', 
        minimumInvestment: 1500, 
        funds: { 
            secure: ['fund-002', 'fund-003', 'fund-015', 'fund-001', 'fund-004'], 
            moderate: ['fund-002', 'fund-003', 'fund-005', 'fund-007', 'fund-016', 'fund-015', 'fund-006'], 
            dynamic: ['fund-003', 'fund-005', 'fund-007', 'fund-011', 'fund-012', 'fund-017', 'fund-004'] 
        } 
    },
    { 
        contractId: 'fipavie-expertises', 
        name: 'Fipavie Expertises', 
        minimumInvestment: 15000, 
        funds: { 
            secure: ['fund-001', 'fund-002', 'fund-003', 'fund-015', 'fund-004'], 
            moderate: ['fund-001', 'fund-003', 'fund-005', 'fund-016', 'fund-015', 'fund-006'], 
            dynamic: ['fund-003', 'fund-005', 'fund-011', 'fund-012', 'fund-017', 'fund-004'] 
        } 
    },
    { 
        contractId: 'per-opportunites', 
        name: 'PER Opportunités', 
        minimumInvestment: 1000, 
        funds: { 
            secure: ['fund-001', 'fund-003', 'fund-015', 'fund-002', 'fund-004'], 
            moderate: ['fund-001', 'fund-003', 'fund-005', 'fund-016', 'fund-015', 'fund-006'], 
            dynamic: ['fund-003', 'fund-005', 'fund-011', 'fund-012', 'fund-017', 'fund-004'] 
        } 
    },
    { 
        contractId: 'premavenir-per', 
        name: 'Premavenir PER', 
        minimumInvestment: 500, 
        funds: { 
            secure: ['fund-002', 'fund-003', 'fund-015', 'fund-001'], 
            moderate: ['fund-002', 'fund-003', 'fund-005', 'fund-016', 'fund-015'], 
            dynamic: ['fund-005', 'fund-011', 'fund-012', 'fund-017', 'fund-004'] 
        } 
    }
];
